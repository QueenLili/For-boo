            ...
            <div className="content">
              ...
              <div className="letter" ref={letterRef}>
                <div className="body">
                  ...
                  <div className="message">Hi baby, I love you so much. You mean the world to me, I never want to stop showing you that. To the ends of the Milkyway & back xx</div>
                </div>
              </div>
            </div>
          </div>
